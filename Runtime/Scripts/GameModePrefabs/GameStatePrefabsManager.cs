...
public class GameStatePrefabsManager : ScriptableObject
{
    ...
    {
        IEnumerable<System.Type> subclassTypes = Assembly
        .GetAssembly(typeof(GameStateWithAddressableAssets))
        .GetTypes()
        .Where(t => t.IsSubclassOf(typeof(GameStateWithAddressableAssets)) && !t.IsAbstract);
